...
function checkUvedButton() {
    ...
    if (uvedButton.checked) {
        alert('Не забудьте разрешить уведомления для данной страницы! Чаще всего в конце адресной строки браузера есть кнопка.'); // Показываем алерт с напоминанием
